        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <FadeInSection threshold={0.2} triggerOnce={false}>
            <div>
              ...
              <p className="font-body text-base text-gray-800 mb-6 leading-relaxed tracking-wide">
                <span className="text-gray-900 font-semibold">Da oltre 35 anni</span> realizziamo progetti di costruzione di alta qualità, 
                combinando <span className="text-gray-900 font-semibold">tradizione artigianale e innovazione tecnologica</span>. La nostra 
                missione è <span className="text-gray-900 font-semibold">trasformare visioni in realtà</span>, costruendo spazi che durano nel tempo 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <FadeInSection delay={100} triggerOnce={false}>
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="font-body text-gray-800 tracking-wide">Qualità certificata</span>
                  </div>
                </FadeInSection>
                <FadeInSection delay={200} triggerOnce={false}>
                  <div className="flex items-center space-x-3">
                    <Clock className="w-6 h-6 text-red-600" />
                    <span className="font-body text-gray-800 tracking-wide">Puntualità garantita</span>
                  </div>
                </FadeInSection>
                <FadeInSection delay={300} triggerOnce={false}>
                  <div className="flex items-center space-x-3">
                    <Users className="w-6 h-6 text-red-600" />
                    <span className="font-body text-gray-800 tracking-wide">Team esperto</span>
                  </div>
                </FadeInSection>
              </div>
