  ...
  return (
    <FadeInSection triggerOnce={false} threshold={0.2}>
      <div className="relative w-full">
        ...
        <div className="absolute top-0 left-0 right-0 h-[0.5px] bg-gradient-to-r from-transparent via-red-600 to-transparent z-10"></div>
        ...
        <section className="py-12 bg-[#0d0d0d] w-full backdrop-blur-sm relative mt-6 shadow-xl">
          {/* Pattern decorativo */}
          <div className="absolute inset-0 opacity-10 z-0" style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'20\' height=\'20\' viewBox=\'0 0 20 20\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'%23000000\' fill-opacity=\'1\' fill-rule=\'evenodd\'%3E%3Ccircle cx=\'3\' cy=\'3\' r=\'1\'/%3E%3C/g%3E%3C/svg%3E")', backgroundSize: '20px 20px' }}></div>
                  ...
                  <FadeInSection key={index} delay={(index * 100) as 0 | 100 | 200 | 300 | 400} triggerOnce={false}>
                    ...
                    >
                      <div className="relative">
                        ...
                        <div className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-10 h-[0.5px] bg-red-500/40"></div>
                      </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-red-600 to-transparent z-10"></div>
        </section>
      </div>
    </FadeInSection>
  );
